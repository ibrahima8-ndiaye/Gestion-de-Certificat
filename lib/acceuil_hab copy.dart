...
class _AcceuilHabitantState extends State<AcceuilHabitant> {
  ...
  _historiqueCertificats(context) {
    final double heightElementsEnHaut = 325; // cette valeur a ete determine manuellement, implementation a ameliorer
...
class CardHistoriqueCert extends StatelessWidget {
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Image.asset("assets/images/cert-icon-min-sb.png",),
  ...
  //       ),
  //       child: const Text(
  //         "Certificat numero 127192",
  //         style: TextStyle(fontSize: 20, color: Color.fromARGB(255, 33, 129, 101)),
  //       ),
  //     ),
  //   );
  // }
